...
const pingInterval = process.env.SAMPLE_PROJECT_PING_INTERVAL || 5000
const pingpongIntervalFail = process.env.SAMPLE_PROJECT_PINGPONGFAIL_INTERVAL || 10000
const socketsPort = process.env.SAMPLE_PROJECT_SOCKETS_PORT || 8999
